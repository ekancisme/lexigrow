...
<p align="center">
  <a href="https://github.com/ekancisme/lexigrow">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=24&duration=3000&pause=1000&color=005BBF&center=true&vCenter=true&width=650&lines=Measured+Writing+Growth;Contextual+Vocabulary+Micro-Learning;AI-Powered+Inline+Heatmap+Feedback;From+Spaced+Repetition+to+Active+Mastery" alt="Typing SVG" />
  </a>
</p>
...
[![Google Gemini](https://img.shields.io/badge/Gemini_AI-8E75B2?style=for-the-badge&logo=google&logoColor=white)](https://deepmind.google/technologies/gemini/)
[![Tests Passing](https://img.shields.io/badge/Vitest_Tests-174%2F174_Passed-success?style=for-the-badge&logo=vitest&logoColor=white)](https://vitest.dev/)
...
```mermaid
flowchart LR
    A[🌟 1. Onboarding\nSở thích & Mục tiêu] --> B[🏠 2. Today's Hub\nPhiên 10 Phút]
    B --> C[📖 3. Word Lesson\nIPA, Collocations, Audio]
    C --> D[⚡ 4. Practice Quiz\nTrắc nghiệm & Điền từ]
    D --> E[✍️ 5. Smart Writing\nViết 60-100 từ có Target Words]
    E --> F[🤖 6. AI Inline Feedback\nHeatmap & Rubric 4 Trạng thái]
    F --> G[🔄 7. Revision Diff\nSo sánh bản sửa đổi]
    G --> H[🌳 8. Growth Garden & SRS\nKhu vườn tri thức & Tháp vốn từ]
```
